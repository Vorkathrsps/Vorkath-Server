...
public class IfButtonDPacketListener implements PacketListener {
    ...
    public void handleMessage(Player player, Packet packet) {
        ...
        System.out.println(STR."IfButtonD(selectedInterfaceId=\{selectedInterfaceId}, selectedComponentId=\{selectedComponentId}, selectedSub=\{selectedSub}, selectedObj=\{selectedObj}, targetInterfaceId=\{targetInterfaceId}, targetComponentId=\{targetComponentId}, targetSub=\{targetSub}, targetObj=\{targetObj})");
    }
}
