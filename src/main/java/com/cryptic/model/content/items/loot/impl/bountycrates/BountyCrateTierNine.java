...
public class BountyCrateTierNine implements CollectionItemListener {
        ...
        return new CollectionItem[]
            {
                ...
                new CollectionItem(ItemIdentifiers.BLIGHTED_SUPER_RESTORE4 + 1, 50, 9, false),
                new CollectionItem(ItemIdentifiers.COINS_995, 50, 250_000, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_ANGLERFISH + 1, 50, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_KARAMBWAN + 1, 50, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_MANTA_RAY + 1, 50, 45, false),
            };
    }

    @Override
    public String name() {
        return "Bounty Crate (Tier 9)";
    }

    @Override
    public int id() {
        return ItemIdentifiers.BOUNTY_CRATE_TIER_9;
    }
