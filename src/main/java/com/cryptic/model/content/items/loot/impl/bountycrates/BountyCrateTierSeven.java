...
public class BountyCrateTierSeven implements CollectionItemListener {
    @Override
        ...
        return new CollectionItem[]
            {
                ...
                new CollectionItem(ItemIdentifiers.BLIGHTED_SUPER_RESTORE4 + 1, 100, 9, false),
                new CollectionItem(ItemIdentifiers.COINS_995, 100, 250_000, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_ANGLERFISH + 1, 100, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_KARAMBWAN + 1, 100, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_MANTA_RAY + 1, 100, 45, false),
            };
    }

    @Override
    public String name() {
        return "Bounty Crate (Tier 7)";
    }

    @Override
    public int id() {
        return ItemIdentifiers.BOUNTY_CRATE_TIER_7;
    }
