...
public class BountyCrateTierSix implements CollectionItemListener {
    @Override
        ...
        return new CollectionItem[]
            {
                ...
                new CollectionItem(ItemIdentifiers.BLIGHTED_SUPER_RESTORE4 + 1, 125, 9, false),
                new CollectionItem(ItemIdentifiers.COINS_995, 125, 250_000, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_ANGLERFISH + 1, 125, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_KARAMBWAN + 1, 125, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_MANTA_RAY + 1, 125, 45, false),
            };
    }

    @Override
    public String name() {
        return "Bounty Crate (Tier 6)";
    }

    @Override
    public int id() {
        return ItemIdentifiers.BOUNTY_CRATE_TIER_6;
    }
