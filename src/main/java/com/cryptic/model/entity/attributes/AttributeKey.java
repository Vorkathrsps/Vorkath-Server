...
public enum AttributeKey {
    ...
    STARTER_SWORD_CHARGES, SIGIL_OF_STAMINA, SIGIL_OF_ALCHEMANIAC, ALCHEMANIAC_BOOST, SIGIL_OF_EXAGGERATION, EXAGGERATION_BOOST, SIGIL_OF_DEVOTION, DEVOTION, SIGIL_OF_LAST_RECALL, SAVE_LAST_TILE, LAST_SAVED_TILE;
