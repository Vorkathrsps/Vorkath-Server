...
public class InstanceHeight {
    ...
    private static final Logger logger = LogManager.getLogger(InstanceHeight.class);
    ...
    public static HashSet<Integer> getReserved() {
        return RESERVED;
    }
    ...
    public static int getFree() {
        for (int height = 4; height <= MAXIMUM_HEIGHT; height += STEP) {
