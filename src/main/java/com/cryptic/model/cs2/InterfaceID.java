...
public final class InterfaceID {
    ...
    public static final int SKILL_INFORMATION = 860;
    ...
    public static final int DIALOG_MESSAGE_BOX = 229;
    ...
    public static final int CLAN_CHAT = 707;

    public static final int ACCOUNT_MANAGEMENT = 109;

    public static final int QUEST_ROOT = 629;
    ...
    public static final int ORBS = 33;
    ...
    public static final int XP_DROPS = 137;
