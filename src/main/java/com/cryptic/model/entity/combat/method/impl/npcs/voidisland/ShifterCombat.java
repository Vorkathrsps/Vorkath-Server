...
public class ShifterCombat extends CommonCombatMethod {
    @Override
    ...
    public void onDeath(Player killer, NPC npc) {
        if (killer != null) {
            var increment = 1;
            switch (npc.id()) {
                case 1703, 1702 -> increment += 2;
                case 1701 -> increment += 1;
            }
            ...
            killer.message("<lsprite=2009>" + Color.COOL_BLUE.wrap("<shad=0>You have received " + increment + " Void Island point.</shad>"));
