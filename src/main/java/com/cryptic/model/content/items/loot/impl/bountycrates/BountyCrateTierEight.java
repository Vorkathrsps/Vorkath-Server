...
public class BountyCrateTierEight implements CollectionItemListener {
    @Override
        ...
        return new CollectionItem[]
            {
                ...
                new CollectionItem(ItemIdentifiers.BLIGHTED_SUPER_RESTORE4 + 1, 80, 9, false),
                new CollectionItem(ItemIdentifiers.COINS_995, 80, 250_000, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_ANGLERFISH + 1, 80, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_KARAMBWAN + 1, 80, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_MANTA_RAY + 1, 80, 45, false),
            };
    }

    @Override
    public String name() {
        return "Bounty Crate (Tier 8)";
    }

    @Override
    public int id() {
        return ItemIdentifiers.BOUNTY_CRATE_TIER_8;
    }
