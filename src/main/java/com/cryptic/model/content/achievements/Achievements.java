...
public enum Achievements {
    ...
    SLAYER_4(80614, "Slayer IV", "Complete 50 Slayer Tasks.", 50, Difficulty.EASY, new Item(COINS_995, 30_000_000), new Item(DOUBLE_XP_LAMP, 5), new Item(DOUBLE_DROPS_LAMP, 2), new Item(BOX_OF_VALOR)),
    ...
    LARRAN_FRENZY_III(80625, "Larran's Frenzy III", "Open the Larran's chest 100 times.", 100, Difficulty.HARD, new Item(LARRANS_KEY, 15), new Item(BOX_OF_VALOR)),
    ...
    SKILLER_I(80629, "Skiller I", "Earn a total level of 750.", 1, Difficulty.EASY, new Item(DOUBLE_XP_LAMP, 2), new Item(BOX_OF_VALOR)),
    ...
    VORKY_II(80679, "Vorkath II", "Kill 100 Vorkaths.", 100, Difficulty.HARD, new Item(COINS_995, 10_000_000), new Item(BOX_OF_VALOR), new Item(BLUE_DRAGONHIDE + 1, 100), new Item(SUPERIOR_DRAGON_BONES + 1, 100)),
    ...
    SNAKE_CHARMER_III(80682, "Swampletics III", "Kill 100 Zulrah.", 100, Difficulty.HARD, new Item(COINS_995, 10_000_000), new Item(SERPENTINE_HELM), new Item(BOX_OF_VALOR), new Item(DOUBLE_DROPS_LAMP)),
    NEX_I(80683, "Frost Bite I", "Kill 5 Nex.", 5, Difficulty.HARD, new Item(COINS_995, 10_000_000), new Item(BOX_OF_VALOR)),
    NEX_II(80684, "Frost Bite II", "Kill 15 Nex.", 15, Difficulty.HARD, new Item(COINS_995, 15_000_000), new Item(BOX_OF_VALOR)),
    NEX_III(80685, "Frost Bite III", "Kill 25 Nex.", 25, Difficulty.HARD, new Item(COINS_995, 20_000_000), new Item(BOX_OF_VALOR)),
    ...
    GODWARS_II(80687, "Godwars II", "Kill 50 Godwars Bosses.", 50, Difficulty.HARD, new Item(COINS_995, 10_000_000), new Item(BOX_OF_VALOR)),
    GODWARS_III(80688, "Godwars III", "Kill 100 Godwars Bosses.", 100, Difficulty.HARD, new Item(COINS_995, 20_000_000), new Item(BOX_OF_VALOR)),
    ...
    SCURRIUS_III(80691, "Rat Poison III", "Kill 75 Scurrius.", 75, Difficulty.HARD, new Item(COINS_995, 6_000_000), new Item(BOX_OF_VALOR), new Item(DOUBLE_DROPS_LAMP)),
