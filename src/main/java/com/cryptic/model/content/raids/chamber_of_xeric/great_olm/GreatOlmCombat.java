...
import static com.cryptic.cache.definitions.identifiers.NpcIdentifiers.GREAT_OLM_LEFT_CLAW_7555;
import static com.cryptic.cache.definitions.identifiers.NpcIdentifiers.GREAT_OLM_RIGHT_CLAW_7553;
import static com.cryptic.cache.definitions.identifiers.ObjectIdentifiers.*;
import static com.cryptic.model.content.raids.chamber_of_xeric.great_olm.GreatOlmCombat.Facing.*;
import static com.cryptic.model.entity.attributes.AttributeKey.OLM_BURN_EFFECT;
 ...
 */
public class GreatOlmCombat extends CommonCombatMethod {
    ...
    @Override
    public void postDamage(Hit hit) {
        if (hit.getDamage() == 0 || hit.getHitMark() == HitMark.HEAL || entity.dead())
            return;
    ...
    public void siphonAttack(NPC npc) {
        ...
        Chain.noCtx().delay(4, () -> {
            ...
            npc.hit(npc, damageDealt * 3, HitMark.HEAL);
        });
