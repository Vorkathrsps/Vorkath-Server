...
public enum KnifeDrawback {
    ...
    TONALZTICKS(28922, 2734, 2729, 24, 30, 36, 2, GraphicHeight.LOW);

    public final int arrow, gfx, projectile, startSpeed, startHeight, endHeight, stepMultiplier;
    public GraphicHeight graphicHeight;
    ...
    KnifeDrawback(int arrow, int gfx, int projectile, int startSpeed, int startHeight, int endHeight, int stepMultiplier, GraphicHeight graphicHeight) {
        this.arrow = arrow;
        this.gfx = gfx;
        this.projectile = projectile;
        this.startSpeed = startSpeed;
