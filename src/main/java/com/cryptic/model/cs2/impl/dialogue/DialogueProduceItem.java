...
public class DialogueProduceItem extends InterfaceBuilder {
    ...
    public void beforeOpen(Player player) {
        ...
        player.getPacketSender().runClientScriptNew(2046, 0, activeDialogueProduceItemItemRecord.title() + String.join("", nameArray), activeDialogueProduceItemItemRecord.maxCanMake(), itemArray);
    }
