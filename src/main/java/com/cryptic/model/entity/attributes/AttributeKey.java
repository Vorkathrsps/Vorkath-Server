...
public enum AttributeKey {
    ...
    KILLING_BLOW_HIT, RECENT_LISTING_RESULTS, BUY_LISTING_RESULTS, LAVA_BEASTS_KILLED, DERANGED_ARCHAEOLOGIST_KILLED, EL_FUEGO_KILLED, NEX_KILLED, BARRIER_BROKEN, LOCKED_FROM_MOVEMENT, SMOKE_PHASE_INITIATED, SHADOW_PHASE_INITIATED, BLOOD_PHASE_INITIATED, ICE_PHASE_INITIATED,
    FUCKU1, FUCK2, OLM_BURN_EFFECT,

    RAID_PARTY, WILDERNESS_KEY, NPC_LINKED_TO_PLAYER, NEX_VIRUS, SPAWNED_LINKED_NPC, NIGHTMARE_CURSE, NIGHTMARE_SHIELD, VETION_ENTRY_FEE, ZERKER_MELEE_PRESET, PURE_MELEE_PRESET, MAIN_MELEE_PRESET, PRESET_SAVE_ONE, CUSTOM_PRESETS, LAST_PRESET_BUTTON_CLICKED,
    MAIN_MELEE,ZERKER_MELEE,PURE_MELEE,MAIN_TRIBRID,ZERKER_TRIBRID,PURE_TRIBRID,MAIN_HYBRID,ZERKER_HYBRID, CHOKED, INVULNERABLE, RESISTANCE, TITANIUM, PRECISION,

    DOOR_ORIG_ID,

    STARTER_BOW_CHARGES,
    STARTER_STAFF_CHARGES,
    STARTER_SWORD_CHARGES, SIGIL_OF_STAMINA, SIGIL_OF_ALCHEMANIAC, ALCHEMANIAC_BOOST, SIGIL_OF_EXAGGERATION, EXAGGERATION_BOOST, SIGIL_OF_DEVOTION, DEVOTION, SIGIL_OF_LAST_RECALL, SAVE_LAST_TILE, LAST_SAVED_TILE, SIGIL_OF_REMOTE_STORAGE, REMOTE_STORAGE, SIGIL_OF_THE_NINJA, NINJA;
