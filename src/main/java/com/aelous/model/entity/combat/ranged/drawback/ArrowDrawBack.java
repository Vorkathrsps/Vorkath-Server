...
public enum ArrowDrawBack {
     ...
     */
    BRONZE_ARROW(882, -1, 19, 10, 45, 36, 41,5 ),
    IRON_ARROW(884, -1, 18, 9, 45, 36, 41,5),
    STEEL_ARROW(886, -1, 20, 11, 45, 36, 41,5),
    MITHRIL_ARROW(888, -1, 21, 12, 45, 36, 41,5),
    ADAMANT_ARROW(890, -1, 22, 13, 45, 36, 41,5),
    RUNITE_ARROW(892, -1, 24, 15, 45, 36, 41,5),
    AMETHYST_ARROW(21326, -1, 1385, 1384, 45, 36, 41,5),
    DRAGON_ARROW(11212, -1, 1116, 1120, 45, 36, 41,5),
    DRAGON_ARROW_20389(20389, -1, 1116, 1120, 45, 36, 41,5),
    DRAGON_ARROW_P(11227, -1, 1116, 1120, 45, 36, 41,5),
    DRAGON_ARROW_P_PLUS(11228, -1, 1116, 1120, 45, 36, 41,5),
    DRAGON_ARROW_P_PLUS_PLUS(11229, -1, 1116, 1120, 45, 36, 41,5),
    FIRE_ARROW(4160, -1, 20, 11, 45, 36, 41,5),
    ICE_ARROW(78, -1, 1116, 1120, 45, 36, 41,5),

    /**
     * Javelin Drawsbacks & End Gfx
     */
    BRONZE_JAV(825, -1, 344, 200, 45, 36, 41,5),
    IRON_JAV(826, -1, 344, 201, 45, 36, 41,5),
    STEEL_JAV(827, -1, 344, 202, 45, 36, 41,5),
    MITHRIL_JAV(828, -1, 344, 203, 45, 36, 41,5),
    ADDY_JAV(829, -1, 344, 204, 45, 36, 41,5),
    RUNE_JAV(830, -1, 344, 205, 45, 36, 41,5),
    AMETHYST_JAV(21318, -1, 344, 1386, 45, 36, 41,5),
    DRAGON_JAV(19484, -1, 344, 1301, 45, 36, 41,5),
    ...
    BOW_OF_FAERDHENIN_CRWYS(-1, 25892, 1933, 1934, 40, 36, 41,5),
    BOW_OF_FAERDHENIN_AMLODD(-1, 25896, 1935, 1934, 40, 36, 41,5),
    CRAWS_BOW(-1, 22550, 1611, 1574, 45, 36, 41,5),
    WEB_WEAVER_BOW(-1, 27655, 1611, 1574, 45, 36, 41,5);
