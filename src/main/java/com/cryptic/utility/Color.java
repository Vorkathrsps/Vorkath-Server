...
public enum Color {
    ...
    ANCIENTWARRIOR("DDC996"), PURPLE("7800FF"), LIGHTGREYbut("CCCCCC"), RED("FF0000"), GOLDENROD("E5A910"),
    ...
    MAROON("800000"), GREEN("0DC10D"), LIGHT_GREEN("006000"), DARK_RED("6f0000"), DARK_GREEN("006600"),
