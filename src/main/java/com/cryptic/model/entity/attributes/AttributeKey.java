...
public enum AttributeKey {
    ...
    SIGIL_OF_REMOTE_STORAGE, REMOTE_STORAGE, SIGIL_OF_THE_NINJA, NINJA, SIGIL_OF_INFERNAL_SMITH, INFERNAL_SMITH, EXO_SKELETON, MARK_OF_DARKNESS, TORNADO_DAMAGE, UNLIT_BRAZIER_VARBIT, SPEARING, AFK, SIGIL_OF_PIOUS_PROTECTION, SIGIL_OF_AGGRESSION, SIGIL_OF_TREASURE_HUNTER, TREASURE_HUNTER_BOOST;
