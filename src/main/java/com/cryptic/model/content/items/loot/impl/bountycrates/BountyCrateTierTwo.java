...
public class BountyCrateTierTwo implements CollectionItemListener {
        ...
        return new CollectionItem[]
            {
                ...
                new CollectionItem(ItemIdentifiers.BLIGHTED_SUPER_RESTORE4 + 1, 225, 9, false),
                new CollectionItem(ItemIdentifiers.COINS_995, 225, 250_000, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_ANGLERFISH + 1, 225, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_KARAMBWAN + 1, 225, 45, false),
                new CollectionItem(ItemIdentifiers.BLIGHTED_MANTA_RAY + 1, 225, 45, false),
            };
    }

    @Override
    public String name() {
        return "Bounty Crate (Tier 2)";
    }

    @Override
    public int id() {
        return ItemIdentifiers.BOUNTY_CRATE_TIER_2;
    }
