 ...
 * april 02, 2020
 */
public class ChaoticDeathSpawnMagicCombat extends CommonCombatMethod {
    ...
    public boolean prepareAttack(Entity entity, Entity target) {
        ...
        Projectile p = new Projectile(entity, target, 393, 51, duration, 43, 31, 0, entity.getSize(), 10);
