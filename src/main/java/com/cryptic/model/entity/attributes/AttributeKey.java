...
public enum AttributeKey {
    ...
    DUKE_LOG_CLAIMED, ENHANCED_CRYSTAL_KEYS_OPENED("enhanced_crystal_keys_opened", AttribType.INTEGER), ENHANCED_CRYSTAL_KEY_LOG_CLAIMED, DOUBLE_DROPS, DOUBLE_XP, WOODCUTTING_DAILY_TASK_COMPLETION_AMOUNT, WOODCUTTING_DAILY_TASK_COMPLETED, WOODCUTTING_DAILY_TASK_REWARD_CLAIMED, MONKFISH_DAILY_TASK_COMPLETION_AMOUNT, MONKFISH_DAILY_TASK_COMPLETED, MONKFISH_DAILY_TASK_REWARD_CLAIMED, MINING_DAILY_COMPLETION_AMOUNT, MINING_DAILY_REWARD_CLAIMED, MINING_DAILY_COMPLETED, FISHING_DAILY_COMPLETION_AMOUNT, FISHING_DAILY_COMPLETED, FISHING_DAILY_REWARD_CLAIMED, THIEVING_DAILY_COMPLETION_AMOUNT, THIEVING_DAILY_COMPLETED, THIEVING_DAILY_REWARD_CLAIMED, PRAYER_DAILY_COMPLETION_AMOUNT, PRAYER_DAILY_COMPLETED, PRAYER_DAILY_REWARD_CLAIMED, BOSSING_DAILY_COMPLETION_AMOUNT, BOSSING_DAILY_COMPLETED, BOSSING_DAILY_REWARD_CLAIMED, BEGINNER_REWARDS_OPENED, EASY_CASKET_OPENED, MEDIUM_CLUE_REWARD_OPENED, HARD_CASKET_OPENED, ELITE_CASKET_OPENED, MASTER_CASKET_OPENED,
    DAILY_BONE_NAME, DAILY_BONE_DESC,
    DAILY_BOSS_NAME, DAILY_BOSS_DESC,
    DAILY_COOKING_NAME, DAILY_COOKING_DESC, DAILY_SLAYER_DESC, DAILY_SLAYER_NAME, DAILY_MINING_NAME, DAILY_MINING_DESC, DAILY_FISHING_NAME, DAILY_FISHING_DESC, DAILY_THIEVING_NAME, DAILY_THIEVING_DESC, DAILY_WOODCUTTING_NAME, DAILY_WOODCUTTING_DESC;
