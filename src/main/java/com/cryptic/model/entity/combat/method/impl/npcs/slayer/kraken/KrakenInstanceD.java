...
public class KrakenInstanceD extends Dialogue {
    ...
    protected void start(Object... parameters) {
        sendItemStatement(new Item(BLOOD_MONEY), "", "Would you like to pay the fee to enter an instanced area?", "<col=FF0000>Warning: any items dropped on death are permanently lost.", "When you leave, you'll have to pay again to enter.");
        setPhase(0);
    }
    ...
    protected void next() {
        if(getPhase() == 0) {
            sendOption(DEFAULT_OPTION_TITLE, "Pay " + currencyReq + " " + currency + " to enter.", "Never mind.");
            setPhase(1);
        }
    }
