...
public enum CombatSpecial {
    ...
    ARMADYL_GODSWORD(new int[]{ItemIdentifiers.ARMADYL_GODSWORD, 20593}, 50, 1.25 * 1.10, 1.50, new ArmadylGodsword(), WeaponType.TWOHANDED),
    ANCIENT_GODSWORD(new int[]{ItemIdentifiers.ANCIENT_GODSWORD}, 50, 1.10, 1.50, new AncientGodsword(), WeaponType.TWOHANDED),
    ...
    DRAGON_CLAWS(new int[]{ItemIdentifiers.DRAGON_CLAWS}, 50, 1.25, 3.00, new DragonClaws(), WeaponType.CLAWS),
    ...
    VESTA_LONGSWORD(new int[]{ItemIdentifiers.VESTAS_LONGSWORD_23615}, 25, 1.20, 2.50, new VestasLongsword(), WeaponType.LONGSWORD),
