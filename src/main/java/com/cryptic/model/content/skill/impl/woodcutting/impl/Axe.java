...
public enum Axe {
    ...
    MITHRIL_FELLING(28208, 10068, 21,
        new int[][]
            {
                {160, 500},
                {80, 250},
    ...
    ADAMANT_FELLING(28211, 10069, 31,
        new int[][]
            {
                {192, 600},
                {96, 300},
    ...
    CRYSTAL_FELLING(28220, 10072, 71,
        new int[][]
            {
                {232, 800},
                {125, 375},
    ...
    THIRDAGE_FELLING(28226, 10074, 61,
        new int[][]
            {
                {232, 800},
                {125, 375},
