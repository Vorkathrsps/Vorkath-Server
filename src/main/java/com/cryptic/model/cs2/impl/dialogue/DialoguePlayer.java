...
import com.cryptic.model.inter.dialogue.records.DialoguePlayerRecord;
...
public class DialoguePlayer extends InterfaceBuilder {
    ...
    public void beforeOpen(Player player) {
        DialoguePlayerRecord dialoguePlayerRecord = player.activePlayerDialogue;
        if (dialoguePlayerRecord == null) return;
