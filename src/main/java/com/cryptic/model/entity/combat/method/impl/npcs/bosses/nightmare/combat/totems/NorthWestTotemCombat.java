...
public class NorthWestTotemCombat extends CommonCombatMethod {
    ...
    public void postDamage(Hit hit) {
        ...
        player.getPacketSender().sendProgressBar(75004, damageCount);
    }
    @Override
    ...
    public boolean customOnDeath(Hit hit) {
        ...
        player.getPacketSender().sendProgressBar(75004, 100);
        return true;
    }
