package com.cryptic.model.content.treasure.pvpcache;
        ...
        if (randomChance.nextDouble() < 0.2) {
            ...
            if (reward != null) {
                ...
                if (!player.getUsername().equalsIgnoreCase("Box test"))
                    World.getWorld().sendWorldMessage("<lsprite=2010> " + player.getUsername() + " has just received <col=" + Color.BLACK.getColorValue() + ">" + Utils.getAOrAn(reward.name()) + " " + reward.name() + " from a frozen pvp cache!");
            }
        }
    }
}
