...
import com.cryptic.model.entity.combat.method.impl.npcs.verzik.nylocas.Athanatos;
import com.cryptic.model.entity.combat.method.impl.npcs.verzik.nylocas.Matomenos;
                    ...
                    Task task = new Task("VerzikViturPrepareAttackTask3", 1) {
                        ...
                        public void execute() {
                            ...
                            if (count == 5 && nylocasAthanatos == null && bomber == null) {
                                ...
                                nylocasAthanatos.setInstancedArea(mob.getInstancedArea());
                                ...
                                bomber.animate(8098);
                                bomber.setInstancedArea(mob.getInstancedArea());
