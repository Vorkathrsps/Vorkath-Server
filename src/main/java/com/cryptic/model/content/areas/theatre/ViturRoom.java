package com.cryptic.model.content.areas.theatre;
...
import static com.cryptic.cache.definitions.identifiers.NpcIdentifiers.ROOSTER;
        ...
        if (obj != null && obj.getId() == ROOSTER) { // tob lobby 32653, 3678, 3216
            ...
            Chain.bound(null).runFn(1, () -> {
                ...
                for (Tile pillarTile : pillarTiles) {
                    ...
                    pillarNpc.setInstancedArea(instance);
