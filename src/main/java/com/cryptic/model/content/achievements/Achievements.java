...
public enum Achievements {
    ...
    DAMAGE_DEALER_III(80635, "Damage Dealer III", "Deal 100,000 damage.", 100000, Difficulty.MED, new Item(COINS_995, 20_000_000), new Item(MYSTERY_BOX)),
    DAMAGE_DEALER_IV(80636, "Damage Dealer IV", "Deal 200,000 damage.", 200000, Difficulty.HARD, new Item(COINS_995, 35_000_000), new Item(MYSTERY_BOX, 2)),
