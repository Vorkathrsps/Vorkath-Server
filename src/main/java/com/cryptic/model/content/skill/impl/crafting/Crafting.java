...
import com.cryptic.model.content.skill.impl.crafting.impl.*;
...
import static com.cryptic.utility.ItemIdentifiers.ZENYTE_SHARD;
import static com.cryptic.cache.definitions.identifiers.ObjectIdentifiers.POTTERY_OVEN_11601;
        ...
        switch (button) {
            ...
            case 8946:
                player.setAmountScript("Enter amount:", new InputScript() {
                    ...
                    public boolean handle(Object value) {
                        start(player, craftable, 0, (Integer) value);
                        return true;
                    }
                });
                return true;
            ...
            case 8950:
                player.setAmountScript("Enter amount:", new InputScript() {
                    @Override
                    public boolean handle(Object value) {
                        start(player, craftable, 1, (Integer) value);
                        return true;
                    }
                });
                return true;
            ...
            case 8954:
                player.setAmountScript("Enter amount:", new InputScript() {
                    @Override
                    public boolean handle(Object value) {
                        start(player, craftable, 2, (Integer) value);
                        return true;
                    }
                });
                return true;
            ...
            case 8958:
                player.setAmountScript("Enter amount:", new InputScript() {
                    @Override
                    public boolean handle(Object value) {
                        start(player, craftable, 3, (Integer) value);
                        return true;
                    }
                });
                return true;
            ...
            case 8962:
                player.setAmountScript("Enter amount:", new InputScript() {
                    @Override
                    public boolean handle(Object value) {
                        start(player, craftable, 4, (Integer) value);
                        return true;
                    }
                });
                return true;
