...
public enum AttributeKey {
    ...
    FUCKU1, FUCK2, // nbow this is 828, design flaw will fuck things up in future
    // instead of value you probably want to use the exact name and match that instead, okay send it
    OLM_BURN_EFFECT, // call this 828

    RAID_PARTY, WILDERNESS_KEY, NPC_LINKED_TO_PLAYER, NEX_VIRUS, SPAWNED_LINKED_NPC, NIGHTMARE_CURSE, NIGHTMARE_SHIELD, VETION_ENTRY_FEE, ZERKER_MELEE_PRESET, PURE_MELEE_PRESET, MAIN_MELEE_PRESET, PRESET_SAVE_ONE, CUSTOM_PRESETS, LAST_PRESET_BUTTON_CLICKED, MAIN_MELEE;
