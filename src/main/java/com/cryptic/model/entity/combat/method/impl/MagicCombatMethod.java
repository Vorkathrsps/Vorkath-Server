...
public class MagicCombatMethod extends CommonCombatMethod {
    public static final int[] immune_to_magic = new int[]{NpcIdentifiers.NYLOCAS_TOXOBOLOS_8343, NpcIdentifiers.NYLOCAS_TOXOBOLOS_8346, NpcIdentifiers.NYLOCAS_VASILIAS_8357, NYLOCAS_ISCHYROS_8342, NYLOCAS_ISCHYROS_8345, NYLOCAS_VASILIAS_8355, 7146, 7149, KALPHITE_QUEEN_6500};
    ...
    public int moveCloseToTargetTileRange(Entity entity) {
        if (entity.isPlayer()) {
            Player player = (Player) entity;
            if (player.getEquipment().containsAny(THAMMARONS_SCEPTRE,TRIDENT_OF_THE_SEAS_FULL, TRIDENT_OF_THE_SEAS, TRIDENT_OF_THE_SWAMP, SANGUINESTI_STAFF, TUMEKENS_SHADOW, DAWNBRINGER, ACCURSED_SCEPTRE_A, CORRUPTED_TUMEKENS_SHADOW)) {
                return 8;
            }
        }
        return 10;
