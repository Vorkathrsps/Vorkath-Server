...
public enum AttributeKey {
    ...
    LAST_SAVED_TILE,
    SIGIL_OF_REMOTE_STORAGE, REMOTE_STORAGE, SIGIL_OF_THE_NINJA, NINJA, SIGIL_OF_INFERNAL_SMITH, INFERNAL_SMITH, PREVIOUS_SLAYER_TASK("previous_slayer_task", AttribType.STRING), SLAYER_TASK_UID("slayer_task_uid", AttribType.INTEGER), SLAYER_TASK_AMOUNT_REMAINING("slayer_task_amount_remaining", AttribType.INTEGER), IS_WILDERNESS_TASK("wilderness_task", AttribType.BOOLEAN);
