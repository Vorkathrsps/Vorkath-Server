package com.cryptic.model.content.emote;
...
import static com.cryptic.model.content.items.equipment.max_cape.MaxCape.FROST_IMBUED_MAX_CAPE;
...
public class Emotes {
    ...
    private enum EmoteData {
        ...
        KISS(11100, new Animation(1374), new Graphic(574, GraphicHeight.LOW)),
