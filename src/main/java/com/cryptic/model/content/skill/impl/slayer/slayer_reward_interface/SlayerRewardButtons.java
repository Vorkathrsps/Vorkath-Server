...
public enum SlayerRewardButtons {
    ...
    SLAYERS_GREED(new int[]{63407}, 0, SlayerRewardActions.UNLOCK_BUTTON, 751),
    DEATHS_TOUCH(new int[]{63408}, 0, SlayerRewardActions.UNLOCK_BUTTON, 752),
    EMBLEM_HUNTER(new int[]{63409}, 0, SlayerRewardActions.UNLOCK_BUTTON, 753),
    SLAYERS_NODE(new int[]{63410}, 0, SlayerRewardActions.UNLOCK_BUTTON, 754),
    LARRANS_LUCK(new int[]{63411}, 0, SlayerRewardActions.UNLOCK_BUTTON, 755),
    ANCIENT_BLESSING(new int[]{63412}, 0, SlayerRewardActions.UNLOCK_BUTTON, 756),
    BIGGER_AND_BADDER(new int[]{63413}, 0, SlayerRewardActions.UNLOCK_BUTTON, 757),
    ATTUNED_LUCK(new int[]{63414}, 0, SlayerRewardActions.UNLOCK_BUTTON, 758),
    LIKE_A_BOSS(new int[]{63415}, 0, SlayerRewardActions.UNLOCK_BUTTON, 759),
    BONE_HUNTER(new int[]{63416}, 0, SlayerRewardActions.UNLOCK_BUTTON, 760),
    MALEVOLANT_MASQUERADE(new int[]{63417}, 0, SlayerRewardActions.UNLOCK_BUTTON, 761),
    KING_BLACK_BONNET(new int[]{63418}, 0, SlayerRewardActions.UNLOCK_BUTTON, 762),
    KALPHITE_KHAT(new int[]{63419}, 0, SlayerRewardActions.UNLOCK_BUTTON, 763),
    UNHOLY_HELMET(new int[]{63420}, 0, SlayerRewardActions.UNLOCK_BUTTON, 764),
    DARK_MANTLE(new int[]{63421}, 0, SlayerRewardActions.UNLOCK_BUTTON, 765),
    UNDEAD_HEAD(new int[]{63422}, 0, SlayerRewardActions.UNLOCK_BUTTON, 766),
    USE_MORE_HEAD(new int[]{63423}, 0, SlayerRewardActions.UNLOCK_BUTTON, 767),
    WEAK_SPOT(new int[]{63424}, 0, SlayerRewardActions.UNLOCK_BUTTON, 768),
    TOO_STRONK(new int[]{63425}, 0, SlayerRewardActions.UNLOCK_BUTTON, 769),
    REVVED_UP(new int[]{63426}, 0, SlayerRewardActions.UNLOCK_BUTTON, 770),
    ...
    NULL1(new int[]{63429}, 0, SlayerRewardActions.UNLOCK_BUTTON, 773),
