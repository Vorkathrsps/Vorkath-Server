...
public abstract class CombatEffectSpell extends CombatSpell {
    ...
    public void whenSpellCast(Entity cast, Entity castOn, int spellID) {
        ...
        for (Entity target : targets) {
            ...
            boolean isWearingPoweredStaff = cast.isPlayer() && cast.player().getEquipment().containsAny(TRIDENT_OF_THE_SEAS_FULL, TRIDENT_OF_THE_SEAS, TRIDENT_OF_THE_SWAMP, SANGUINESTI_STAFF, TUMEKENS_SHADOW, DAWNBRINGER, ACCURSED_SCEPTRE_A, CORRUPTED_TUMEKENS_SHADOW, THAMMARONS_SCEPTRE);
