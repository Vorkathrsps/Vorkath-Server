...
public enum AttributeKey {
    ...
    PIOUS_PROTECTION_ACTIVE("pious_protection", AttribType.BOOLEAN),
    AGRESSION_ACTIVE("aggression_active", AttribType.BOOLEAN),
    IS_BOSS_SLAYER_TASK("is_boss_slayer_task", AttribType.BOOLEAN),
    SIGIL_OF_REMOTE_STORAGE, REMOTE_STORAGE, SIGIL_OF_THE_NINJA, NINJA, SIGIL_OF_INFERNAL_SMITH, INFERNAL_SMITH, EXO_SKELETON, MARK_OF_DARKNESS, TORNADO_DAMAGE, UNLIT_BRAZIER_VARBIT, SPEARING, AFK, SIGIL_OF_PIOUS_PROTECTION, SIGIL_OF_AGGRESSION, SIGIL_OF_TREASURE_HUNTER, TREASURE_HUNTER_BOOST, BARON_ENRAGED, SLEEPING, MUSPAH_MELEE, MUSPAH_RANGE, GENERAL_GRAARDOR_LOG_CLAIMED, KREE_ARRA_LOG_CLAIMED, KRIL_LOG_CLAIMED, NEX_LOG_CLAIMED,

    DUKE_KILLED("duke_sucellus_killed", AttribType.INTEGER),

    DUKE_LOG_CLAIMED,
    ENHANCED_CRYSTAL_KEYS_OPENED("enhanced_crystal_keys_opened", AttribType.INTEGER),
    ENHANCED_CRYSTAL_KEY_LOG_CLAIMED,
    DOUBLE_DROPS,
    DOUBLE_XP,

    WOODCUTTING_DAILY_TASK_COMPLETION_AMOUNT(AttribType.INTEGER),
    WOODCUTTING_DAILY_TASK_COMPLETED(AttribType.INTEGER),
    WOODCUTTING_DAILY_TASK_REWARD_CLAIMED(AttribType.BOOLEAN),
    MONKFISH_DAILY_TASK_COMPLETION_AMOUNT(AttribType.INTEGER),
    MONKFISH_DAILY_TASK_COMPLETED(AttribType.INTEGER),
    MONKFISH_DAILY_TASK_REWARD_CLAIMED(AttribType.BOOLEAN),
    MINING_DAILY_COMPLETION_AMOUNT(AttribType.INTEGER),
    MINING_DAILY_REWARD_CLAIMED(AttribType.BOOLEAN),
    MINING_DAILY_COMPLETED(AttribType.INTEGER),
    FISHING_DAILY_COMPLETION_AMOUNT(AttribType.INTEGER),
    FISHING_DAILY_COMPLETED(AttribType.INTEGER),
    FISHING_DAILY_REWARD_CLAIMED(AttribType.BOOLEAN),
    THIEVING_DAILY_COMPLETION_AMOUNT(AttribType.INTEGER),
    THIEVING_DAILY_COMPLETED(AttribType.INTEGER),
    THIEVING_DAILY_REWARD_CLAIMED(AttribType.BOOLEAN),
    PRAYER_DAILY_COMPLETION_AMOUNT(AttribType.INTEGER),
    PRAYER_DAILY_COMPLETED(AttribType.INTEGER),
    PRAYER_DAILY_REWARD_CLAIMED(AttribType.BOOLEAN),
    BOSSING_DAILY_COMPLETION_AMOUNT(AttribType.INTEGER),
    BOSSING_DAILY_COMPLETED(AttribType.INTEGER),
    BOSSING_DAILY_REWARD_CLAIMED(AttribType.BOOLEAN),

    BEGINNER_REWARDS_OPENED, EASY_CASKET_OPENED, MEDIUM_CLUE_REWARD_OPENED,
    HARD_CASKET_OPENED, ELITE_CASKET_OPENED, MASTER_CASKET_OPENED,
    DAILY_BONE_NAME("daily_prayer_name", AttribType.STRING),
    DAILY_BONE_DESC("daily_prayer_description", AttribType.STRING),
    DAILY_BOSS_NAME("daily_boss_name", AttribType.STRING),
    DAILY_BOSS_DESC("daily_boss_description", AttribType.STRING),
    DAILY_COOKING_NAME("daily_cooking_name", AttribType.STRING),
    DAILY_COOKING_DESC("daily_cooking_description", AttribType.STRING),
    DAILY_SLAYER_DESC("daily_slayer_description", AttribType.STRING),
    DAILY_SLAYER_NAME("daily_slayer_name", AttribType.STRING),
    DAILY_MINING_NAME("daily_mining_name", AttribType.STRING),
    DAILY_MINING_DESC("daily_mining_description", AttribType.STRING),
    DAILY_FISHING_NAME("daily_fishing_name", AttribType.STRING),
    DAILY_FISHING_DESC("daily_fishing_description", AttribType.STRING),
    DAILY_THIEVING_NAME("daily_thieving_name", AttribType.STRING),
    DAILY_THIEVING_DESC("daily_thieving_description", AttribType.STRING),
    DAILY_WOODCUTTING_NAME("daily_woodcutting_name", AttribType.STRING),
    DAILY_WOODCUTTING_DESC("daily_woodcutting_description", AttribType.STRING),
    WOODCUTTING_IDENTIFIER(AttribType.STRING),
    BOSSING_IDENTIFIER(AttribType.STRING),
    PRAYER_IDENTIFIER(AttribType.STRING),
    THIEVING_IDENTIFIER(AttribType.STRING),
