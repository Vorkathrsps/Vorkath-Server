...
*/
    ...
    SMITHING_I("Smithing I", "Smith 50 bronze platebody's.", 50, Difficulty.EASY, new Item(COINS_995, 5_000_000), new Item(BLACKSMITHS_HELM)),
    SMITHING_II("Smithing II", "Smith 100 mithril platebody's.", 100, Difficulty.MED, new Item(COINS_995, 10_000_000), new Item(SMITHS_TUNIC)),
    SMITHING_III("Smithing III", "Smith 250 adamant platebody's.", 250, Difficulty.MED, new Item(COINS_995, 20_000_000), new Item(SMITHS_TROUSERS)),
    SMITHING_IV("Smithing IV", "Smith 500 runite platebody's.", 250, Difficulty.HARD, new Item(COINS_995, 35_000_000), new Item(MYSTERY_BOX, 1), new Item(IMCANDO_HAMMER), new Item(SMITHS_BOOTS), new Item(SMITHS_GLOVES)),
