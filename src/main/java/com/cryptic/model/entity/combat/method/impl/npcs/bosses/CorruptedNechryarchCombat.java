 ...
 * 
 */
public class CorruptedNechryarchCombat extends CommonCombatMethod {
    ...
    private void acid_attack(Entity entity, Entity target) {
        ...
        for (int cycle = 0; cycle < 1; cycle++) {
            ...
            Chain.bound(null).runFn(2, () -> {
                ...
                World.getWorld().sendClippedTileGraphic(5001, lastAcidPos, 0, 0);
                World.getWorld().sendClippedTileGraphic(5004, lastAcidPos, 0, 0);
